...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { data: business, error: bizError } = await supabase
      .from("businesses")
      .select("business_name, address, location_url, email, phone, logo_url, contact_email, website")
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding: 12px 0;">
                          <span style="color: #999; font-size: 14px;">💈 Barbero</span><br>
                          <span style="color: #333; font-size: 16px; font-weight: 600;">${escapeHtml(payload.barber_name || "Tu barbero")}</span>
                        </td>
                      </tr>
                    </table>
                  </td>
