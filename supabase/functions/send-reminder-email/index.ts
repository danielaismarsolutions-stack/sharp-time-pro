...
// Copy localizado del email de recordatorio. 'es' es el comportamiento histórico.
const COPY: Record<Language, {
  ...
  es: {
    intlLocale: "es-ES",
    headerTag: "⏰ Recordatorio de Cita",
    htmlTitle: "Recordatorio de Cita",
    hello: (name) => `Hola <strong>${name}</strong>,`,
    intro: "Te recordamos que tienes una cita programada. Aquí están los detalles:",
    dateLabel: "📅 Fecha",
    timeLabel: "🕐 Hora",
    ...
    importantBody: "Si no puedes asistir, por favor cancela tu cita con antelación.",
    seeYou: "¡Te esperamos! 💈",
    cancelButton: "❌ Cancelar Reserva",
    allRightsReserved: "Todos los derechos reservados.",
    subject: (date, time) => `⏰ Recordatorio de tu cita - ${date} a las ${time}`,
    textIntro: "Te recordamos que tienes una cita programada:",
    textCancel: (url) => `Si no puedes asistir, cancela tu cita aquí: ${url}`,
  ...
  en: {
    intlLocale: "en-GB",
    headerTag: "⏰ Appointment Reminder",
    htmlTitle: "Appointment Reminder",
    hello: (name) => `Hi <strong>${name}</strong>,`,
    intro: "This is a friendly reminder about your upcoming appointment. Here are the details:",
    dateLabel: "📅 Date",
    timeLabel: "🕐 Time",
    ...
    importantBody: "If you can't make it, please cancel your appointment in advance.",
    seeYou: "See you soon! 💈",
    cancelButton: "❌ Cancel booking",
    allRightsReserved: "All rights reserved.",
    subject: (date, time) => `⏰ Appointment reminder - ${date} at ${time}`,
    textIntro: "This is a reminder about your upcoming appointment:",
    textCancel: (url) => `If you can't make it, cancel your appointment here: ${url}`,
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // NOTE: consulta separada para degradar a 'es' si la columna language aún no existe.
    let businessLanguage: string | null = null;
    {
      const { data: langRow, error: langError } = await supabase
        ...
        .maybeSingle();
      if (langError) {
        console.warn("[send-reminder-email] Language lookup failed, defaulting to 'es':", langError.message);
      } else {
    ...
    console.log("[send-reminder-email] Sending reminder to:", payload.to_email, "business:", biz.business_name, "language:", language);
...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f5f5f5;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f5f5; padding: 40px 20px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding: 12px 0;">
                          ...
                          <span style="color: #333; font-size: 16px; font-weight: 600;">${escapeHtml(payload.barber_name || staffTerms.yourStaff)}</span>
                        </td>
                      </tr>
                    </table>
                  </td>
    ...
    const greeting = language === "en" ? `Hi ${payload.customer_name},` : `Hola ${payload.customer_name},`;
    const emailText = [
      greeting,
      ``,
      copy.textIntro,
      ...
      `${copy.textServiceLabel}: ${payload.service_name}`,
      `${staffTerms.singularCap}: ${payload.barber_name || staffTerms.yourStaff}`,
